...
// ----------
    ...
    try {
        ...
        $mail->addBCC('sanjaresolutions@gmail.com', 'sanjaresolutions');
        $mail->isHTML(true);
        $mail->Subject = 'Contact form submitted data for cataract';
        ...
        <table style='width: 100%; border: 2px solid black; border-collapse: collapse;'>
            ...
            <tr>
                ...
                <td style='border: 2px solid black;'>Cataract: $message</td>
            </tr>
        </table>";
...
// Send data to CRM
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => array(
                ...
                'extra' => $insurance,
                'table_alias' => 'eyeclinicinpowai_in_cataract',
                'api_key' => '1fdb1b5acd7a198f736656f8b3bebd5a',
            )
        ));
        $resp = curl_exec($curl);
        curl_close($curl);
